...
const of_object_init_f of_object_init_map[] = {
    ...
    (of_object_init_f)of_bsn_tlv_hash_algorithm_init,
    ...
    (of_object_init_f)of_bsn_tlv_outer_src_mac_init,
    ...
    (of_object_init_f)of_bsn_tlv_rest_server_init,
    (of_object_init_f)of_bsn_tlv_routing_param_init,
    ...
    (of_object_init_f)of_port_desc_prop_bsn_speed_capabilities_init,
