...
typedef enum of_object_id_e {
    ...
    OF_BSN_TLV_LOOPBACK_MODE = 375,
    OF_BSN_TLV_LOOPBACK_PORT = 376,
    OF_BSN_TLV_MAC = 377,
    OF_BSN_TLV_MAC_MASK = 378,
    OF_BSN_TLV_MCG_TYPE_VXLAN = 379,
    OF_BSN_TLV_MISS_PACKETS = 380,
    OF_BSN_TLV_MPLS_CONTROL_WORD = 381,
    OF_BSN_TLV_MPLS_LABEL = 382,
    OF_BSN_TLV_MPLS_SEQUENCED = 383,
    OF_BSN_TLV_MULTICAST_INTERFACE_ID = 384,
    OF_BSN_TLV_NAME = 385,
    OF_BSN_TLV_NDP_OFFLOAD = 386,
    OF_BSN_TLV_NDP_STATIC = 387,
    OF_BSN_TLV_NEGATE = 388,
    OF_BSN_TLV_NEXT_HOP_IPV4 = 389,
    OF_BSN_TLV_NEXT_HOP_MAC = 390,
    OF_BSN_TLV_NEXTHOP_TYPE_VXLAN = 391,
    OF_BSN_TLV_NO_ARP_RESPONSE = 392,
    OF_BSN_TLV_NO_NS_RESPONSE = 393,
    OF_BSN_TLV_OFFSET = 394,
    OF_BSN_TLV_OPTICS_ALWAYS_ENABLED = 395,
    OF_BSN_TLV_OUTER_SRC_MAC = 396,
    OF_BSN_TLV_PARENT_PORT = 397,
    OF_BSN_TLV_PARTNER_KEY = 398,
    OF_BSN_TLV_PARTNER_PORT_NUM = 399,
    OF_BSN_TLV_PARTNER_PORT_PRIORITY = 400,
    OF_BSN_TLV_PARTNER_STATE = 401,
    OF_BSN_TLV_PARTNER_SYSTEM_MAC = 402,
    OF_BSN_TLV_PARTNER_SYSTEM_PRIORITY = 403,
    OF_BSN_TLV_PORT = 404,
    OF_BSN_TLV_PORT_SPEED_GBPS = 405,
    OF_BSN_TLV_PORT_USAGE = 406,
    OF_BSN_TLV_PORT_VXLAN_MODE = 407,
    OF_BSN_TLV_PRIORITY = 408,
    OF_BSN_TLV_PUSH_VLAN_ON_INGRESS = 409,
    OF_BSN_TLV_QOS_PRIORITY = 410,
    OF_BSN_TLV_QUEUE_ID = 411,
    OF_BSN_TLV_QUEUE_WEIGHT = 412,
    OF_BSN_TLV_RATE_LIMIT = 413,
    OF_BSN_TLV_RATE_UNIT = 414,
    OF_BSN_TLV_RECORD_PACKETS = 415,
    OF_BSN_TLV_REFERENCE = 416,
    OF_BSN_TLV_REPLY_PACKETS = 417,
    OF_BSN_TLV_REQUEST_PACKETS = 418,
    OF_BSN_TLV_REST_SERVER = 419,
    OF_BSN_TLV_RX_BYTES = 420,
    OF_BSN_TLV_RX_PACKETS = 421,
    OF_BSN_TLV_SAMPLING_RATE = 422,
    OF_BSN_TLV_SET_LOOPBACK_MODE = 423,
    OF_BSN_TLV_STATUS = 424,
    OF_BSN_TLV_STRIP_MPLS_L2_ON_INGRESS = 425,
    OF_BSN_TLV_STRIP_MPLS_L3_ON_INGRESS = 426,
    OF_BSN_TLV_STRIP_VLAN_ON_EGRESS = 427,
    OF_BSN_TLV_SUB_AGENT_ID = 428,
    OF_BSN_TLV_TCP_DST = 429,
    OF_BSN_TLV_TCP_FLAGS = 430,
    OF_BSN_TLV_TCP_SRC = 431,
    OF_BSN_TLV_TIMESTAMP = 432,
    OF_BSN_TLV_TTL = 433,
    OF_BSN_TLV_TUNNEL_CAPABILITY = 434,
    OF_BSN_TLV_TX_BYTES = 435,
    OF_BSN_TLV_TX_PACKETS = 436,
    OF_BSN_TLV_UDF_ANCHOR = 437,
    OF_BSN_TLV_UDF_ID = 438,
    OF_BSN_TLV_UDF_LENGTH = 439,
    OF_BSN_TLV_UDF_OFFSET = 440,
    OF_BSN_TLV_UDP_DST = 441,
    OF_BSN_TLV_UDP_SRC = 442,
    OF_BSN_TLV_UINT64_LIST = 443,
    OF_BSN_TLV_UNICAST_QUERY_TIMEOUT = 444,
    OF_BSN_TLV_UNICAST_RATE = 445,
    OF_BSN_TLV_UNKNOWN_MULTICAST_RATE = 446,
    OF_BSN_TLV_UNTAGGED = 447,
    OF_BSN_TLV_URI_SCHEME = 448,
    OF_BSN_TLV_USE_PACKET_STATE = 449,
    OF_BSN_TLV_VFI = 450,
    OF_BSN_TLV_VFP_CLASS_ID = 451,
    OF_BSN_TLV_VIRTUAL = 452,
    OF_BSN_TLV_VLAN_MAC_LIST = 453,
    OF_BSN_TLV_VLAN_PCP = 454,
    OF_BSN_TLV_VLAN_VID = 455,
    OF_BSN_TLV_VLAN_VID_MASK = 456,
    OF_BSN_TLV_VNI = 457,
    OF_BSN_TLV_VPN_KEY = 458,
    OF_BSN_TLV_VRF = 459,
    OF_BSN_TLV_VXLAN_EGRESS_LAG = 460,
    OF_BSN_VLAN_COUNTER_STATS_ENTRY = 461,
    OF_BSN_VLAN_MAC = 462,
    OF_BSN_VPORT = 463,
    OF_BSN_VPORT_L2GRE = 464,
    OF_BSN_VPORT_Q_IN_Q = 465,
    OF_BSN_VRF_COUNTER_STATS_ENTRY = 466,
    OF_BUCKET = 467,
    OF_BUCKET_COUNTER = 468,
    OF_BUNDLE_PROP = 469,
    OF_BUNDLE_PROP_EXPERIMENTER = 470,
    OF_FLOW_STATS_ENTRY = 471,
    OF_GROUP_DESC_STATS_ENTRY = 472,
    OF_GROUP_STATS_ENTRY = 473,
    OF_HELLO_ELEM = 474,
    OF_HELLO_ELEM_VERSIONBITMAP = 475,
    OF_INSTRUCTION = 476,
    OF_INSTRUCTION_APPLY_ACTIONS = 477,
    OF_INSTRUCTION_BSN = 478,
    OF_INSTRUCTION_BSN_ARP_OFFLOAD = 479,
    OF_INSTRUCTION_BSN_AUTO_NEGOTIATION = 480,
    OF_INSTRUCTION_BSN_DENY = 481,
    OF_INSTRUCTION_BSN_DHCP_OFFLOAD = 482,
    OF_INSTRUCTION_BSN_DISABLE_L3 = 483,
    OF_INSTRUCTION_BSN_DISABLE_SPLIT_HORIZON_CHECK = 484,
    OF_INSTRUCTION_BSN_DISABLE_SRC_MAC_CHECK = 485,
    OF_INSTRUCTION_BSN_DISABLE_VLAN_COUNTERS = 486,
    OF_INSTRUCTION_BSN_HASH_SELECT = 487,
    OF_INSTRUCTION_BSN_INTERNAL_PRIORITY = 488,
    OF_INSTRUCTION_BSN_NDP_OFFLOAD = 489,
    OF_INSTRUCTION_BSN_PACKET_OF_DEATH = 490,
    OF_INSTRUCTION_BSN_PERMIT = 491,
    OF_INSTRUCTION_BSN_PRIORITIZE_PDUS = 492,
    OF_INSTRUCTION_BSN_REQUIRE_VLAN_XLATE = 493,
    OF_INSTRUCTION_BSN_SPAN_DESTINATION = 494,
    OF_INSTRUCTION_CLEAR_ACTIONS = 495,
    OF_INSTRUCTION_EXPERIMENTER = 496,
    OF_INSTRUCTION_GOTO_TABLE = 497,
    OF_INSTRUCTION_ID = 498,
    OF_INSTRUCTION_ID_APPLY_ACTIONS = 499,
    OF_INSTRUCTION_ID_BSN = 500,
    OF_INSTRUCTION_ID_BSN_ARP_OFFLOAD = 501,
    OF_INSTRUCTION_ID_BSN_AUTO_NEGOTIATION = 502,
    OF_INSTRUCTION_ID_BSN_DENY = 503,
    OF_INSTRUCTION_ID_BSN_DHCP_OFFLOAD = 504,
    OF_INSTRUCTION_ID_BSN_DISABLE_L3 = 505,
    OF_INSTRUCTION_ID_BSN_DISABLE_SPLIT_HORIZON_CHECK = 506,
    OF_INSTRUCTION_ID_BSN_DISABLE_SRC_MAC_CHECK = 507,
    OF_INSTRUCTION_ID_BSN_DISABLE_VLAN_COUNTERS = 508,
    OF_INSTRUCTION_ID_BSN_HASH_SELECT = 509,
    OF_INSTRUCTION_ID_BSN_INTERNAL_PRIORITY = 510,
    OF_INSTRUCTION_ID_BSN_NDP_OFFLOAD = 511,
    OF_INSTRUCTION_ID_BSN_PACKET_OF_DEATH = 512,
    OF_INSTRUCTION_ID_BSN_PERMIT = 513,
    OF_INSTRUCTION_ID_BSN_PRIORITIZE_PDUS = 514,
    OF_INSTRUCTION_ID_BSN_REQUIRE_VLAN_XLATE = 515,
    OF_INSTRUCTION_ID_BSN_SPAN_DESTINATION = 516,
    OF_INSTRUCTION_ID_CLEAR_ACTIONS = 517,
    OF_INSTRUCTION_ID_EXPERIMENTER = 518,
    OF_INSTRUCTION_ID_GOTO_TABLE = 519,
    OF_INSTRUCTION_ID_METER = 520,
    OF_INSTRUCTION_ID_WRITE_ACTIONS = 521,
    OF_INSTRUCTION_ID_WRITE_METADATA = 522,
    OF_INSTRUCTION_METER = 523,
    OF_INSTRUCTION_WRITE_ACTIONS = 524,
    OF_INSTRUCTION_WRITE_METADATA = 525,
    OF_MATCH_V1 = 526,
    OF_MATCH_V2 = 527,
    OF_MATCH_V3 = 528,
    OF_METER_BAND = 529,
    OF_METER_BAND_DROP = 530,
    OF_METER_BAND_DSCP_REMARK = 531,
    OF_METER_BAND_EXPERIMENTER = 532,
    OF_METER_BAND_STATS = 533,
    OF_METER_CONFIG = 534,
    OF_METER_FEATURES = 535,
    OF_METER_STATS = 536,
    OF_OXM = 537,
    OF_OXM_ARP_OP = 538,
    OF_OXM_ARP_OP_MASKED = 539,
    OF_OXM_ARP_SHA = 540,
    OF_OXM_ARP_SHA_MASKED = 541,
    OF_OXM_ARP_SPA = 542,
    OF_OXM_ARP_SPA_MASKED = 543,
    OF_OXM_ARP_THA = 544,
    OF_OXM_ARP_THA_MASKED = 545,
    OF_OXM_ARP_TPA = 546,
    OF_OXM_ARP_TPA_MASKED = 547,
    OF_OXM_BSN_EGR_PORT_GROUP_ID = 548,
    OF_OXM_BSN_EGR_PORT_GROUP_ID_MASKED = 549,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED = 550,
    OF_OXM_BSN_GLOBAL_VRF_ALLOWED_MASKED = 551,
    OF_OXM_BSN_IN_PORTS_128 = 552,
    OF_OXM_BSN_IN_PORTS_128_MASKED = 553,
    OF_OXM_BSN_IN_PORTS_512 = 554,
    OF_OXM_BSN_IN_PORTS_512_MASKED = 555,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID = 556,
    OF_OXM_BSN_INGRESS_PORT_GROUP_ID_MASKED = 557,
    OF_OXM_BSN_INNER_ETH_DST = 558,
    OF_OXM_BSN_INNER_ETH_DST_MASKED = 559,
    OF_OXM_BSN_INNER_ETH_SRC = 560,
    OF_OXM_BSN_INNER_ETH_SRC_MASKED = 561,
    OF_OXM_BSN_INNER_VLAN_VID = 562,
    OF_OXM_BSN_INNER_VLAN_VID_MASKED = 563,
    OF_OXM_BSN_IP_FRAGMENTATION = 564,
    OF_OXM_BSN_IP_FRAGMENTATION_MASKED = 565,
    OF_OXM_BSN_L2_CACHE_HIT = 566,
    OF_OXM_BSN_L2_CACHE_HIT_MASKED = 567,
    OF_OXM_BSN_L3_DST_CLASS_ID = 568,
    OF_OXM_BSN_L3_DST_CLASS_ID_MASKED = 569,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID = 570,
    OF_OXM_BSN_L3_INTERFACE_CLASS_ID_MASKED = 571,
    OF_OXM_BSN_L3_SRC_CLASS_ID = 572,
    OF_OXM_BSN_L3_SRC_CLASS_ID_MASKED = 573,
    OF_OXM_BSN_LAG_ID = 574,
    OF_OXM_BSN_LAG_ID_MASKED = 575,
    OF_OXM_BSN_TCP_FLAGS = 576,
    OF_OXM_BSN_TCP_FLAGS_MASKED = 577,
    OF_OXM_BSN_UDF0 = 578,
    OF_OXM_BSN_UDF0_MASKED = 579,
    OF_OXM_BSN_UDF1 = 580,
    OF_OXM_BSN_UDF1_MASKED = 581,
    OF_OXM_BSN_UDF2 = 582,
    OF_OXM_BSN_UDF2_MASKED = 583,
    OF_OXM_BSN_UDF3 = 584,
    OF_OXM_BSN_UDF3_MASKED = 585,
    OF_OXM_BSN_UDF4 = 586,
    OF_OXM_BSN_UDF4_MASKED = 587,
    OF_OXM_BSN_UDF5 = 588,
    OF_OXM_BSN_UDF5_MASKED = 589,
    OF_OXM_BSN_UDF6 = 590,
    OF_OXM_BSN_UDF6_MASKED = 591,
    OF_OXM_BSN_UDF7 = 592,
    OF_OXM_BSN_UDF7_MASKED = 593,
    OF_OXM_BSN_VFI = 594,
    OF_OXM_BSN_VFI_MASKED = 595,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID = 596,
    OF_OXM_BSN_VLAN_XLATE_PORT_GROUP_ID_MASKED = 597,
    OF_OXM_BSN_VRF = 598,
    OF_OXM_BSN_VRF_MASKED = 599,
    OF_OXM_BSN_VXLAN_NETWORK_ID = 600,
    OF_OXM_BSN_VXLAN_NETWORK_ID_MASKED = 601,
    OF_OXM_ETH_DST = 602,
    OF_OXM_ETH_DST_MASKED = 603,
    OF_OXM_ETH_SRC = 604,
    OF_OXM_ETH_SRC_MASKED = 605,
    OF_OXM_ETH_TYPE = 606,
    OF_OXM_ETH_TYPE_MASKED = 607,
    OF_OXM_ICMPV4_CODE = 608,
    OF_OXM_ICMPV4_CODE_MASKED = 609,
    OF_OXM_ICMPV4_TYPE = 610,
    OF_OXM_ICMPV4_TYPE_MASKED = 611,
    OF_OXM_ICMPV6_CODE = 612,
    OF_OXM_ICMPV6_CODE_MASKED = 613,
    OF_OXM_ICMPV6_TYPE = 614,
    OF_OXM_ICMPV6_TYPE_MASKED = 615,
    OF_OXM_IN_PHY_PORT = 616,
    OF_OXM_IN_PHY_PORT_MASKED = 617,
    OF_OXM_IN_PORT = 618,
    OF_OXM_IN_PORT_MASKED = 619,
    OF_OXM_IP_DSCP = 620,
    OF_OXM_IP_DSCP_MASKED = 621,
    OF_OXM_IP_ECN = 622,
    OF_OXM_IP_ECN_MASKED = 623,
    OF_OXM_IP_PROTO = 624,
    OF_OXM_IP_PROTO_MASKED = 625,
    OF_OXM_IPV4_DST = 626,
    OF_OXM_IPV4_DST_MASKED = 627,
    OF_OXM_IPV4_SRC = 628,
    OF_OXM_IPV4_SRC_MASKED = 629,
    OF_OXM_IPV6_DST = 630,
    OF_OXM_IPV6_DST_MASKED = 631,
    OF_OXM_IPV6_EXTHDR = 632,
    OF_OXM_IPV6_EXTHDR_MASKED = 633,
    OF_OXM_IPV6_FLABEL = 634,
    OF_OXM_IPV6_FLABEL_MASKED = 635,
    OF_OXM_IPV6_ND_SLL = 636,
    OF_OXM_IPV6_ND_SLL_MASKED = 637,
    OF_OXM_IPV6_ND_TARGET = 638,
    OF_OXM_IPV6_ND_TARGET_MASKED = 639,
    OF_OXM_IPV6_ND_TLL = 640,
    OF_OXM_IPV6_ND_TLL_MASKED = 641,
    OF_OXM_IPV6_SRC = 642,
    OF_OXM_IPV6_SRC_MASKED = 643,
    OF_OXM_METADATA = 644,
    OF_OXM_METADATA_MASKED = 645,
    OF_OXM_MPLS_BOS = 646,
    OF_OXM_MPLS_BOS_MASKED = 647,
    OF_OXM_MPLS_LABEL = 648,
    OF_OXM_MPLS_LABEL_MASKED = 649,
    OF_OXM_MPLS_TC = 650,
    OF_OXM_MPLS_TC_MASKED = 651,
    OF_OXM_OVS_TCP_FLAGS = 652,
    OF_OXM_OVS_TCP_FLAGS_MASKED = 653,
    OF_OXM_PBB_UCA = 654,
    OF_OXM_PBB_UCA_MASKED = 655,
    OF_OXM_SCTP_DST = 656,
    OF_OXM_SCTP_DST_MASKED = 657,
    OF_OXM_SCTP_SRC = 658,
    OF_OXM_SCTP_SRC_MASKED = 659,
    OF_OXM_TCP_DST = 660,
    OF_OXM_TCP_DST_MASKED = 661,
    OF_OXM_TCP_SRC = 662,
    OF_OXM_TCP_SRC_MASKED = 663,
    OF_OXM_TUNNEL_ID = 664,
    OF_OXM_TUNNEL_ID_MASKED = 665,
    OF_OXM_TUNNEL_IPV4_DST = 666,
    OF_OXM_TUNNEL_IPV4_DST_MASKED = 667,
    OF_OXM_TUNNEL_IPV4_SRC = 668,
    OF_OXM_TUNNEL_IPV4_SRC_MASKED = 669,
    OF_OXM_UDP_DST = 670,
    OF_OXM_UDP_DST_MASKED = 671,
    OF_OXM_UDP_SRC = 672,
    OF_OXM_UDP_SRC_MASKED = 673,
    OF_OXM_VLAN_PCP = 674,
    OF_OXM_VLAN_PCP_MASKED = 675,
    OF_OXM_VLAN_VID = 676,
    OF_OXM_VLAN_VID_MASKED = 677,
    OF_PACKET_QUEUE = 678,
    OF_PORT_DESC = 679,
    OF_PORT_DESC_PROP = 680,
    OF_PORT_DESC_PROP_BSN = 681,
    OF_PORT_DESC_PROP_BSN_BREAKOUT = 682,
    OF_PORT_DESC_PROP_BSN_FORWARD_ERROR_CORRECTION = 683,
    OF_PORT_DESC_PROP_BSN_GENERATION_ID = 684,
    OF_PORT_DESC_PROP_BSN_SPEED_CAPABILITIES = 685,
    OF_PORT_DESC_PROP_BSN_UPLINK = 686,
    OF_PORT_DESC_PROP_ETHERNET = 687,
    OF_PORT_DESC_PROP_EXPERIMENTER = 688,
    OF_PORT_DESC_PROP_OPTICAL = 689,
    OF_PORT_MOD_PROP = 690,
    OF_PORT_MOD_PROP_ETHERNET = 691,
    OF_PORT_MOD_PROP_EXPERIMENTER = 692,
    OF_PORT_MOD_PROP_OPTICAL = 693,
    OF_PORT_STATS_ENTRY = 694,
    OF_PORT_STATS_PROP = 695,
    OF_PORT_STATS_PROP_ETHERNET = 696,
    OF_PORT_STATS_PROP_EXPERIMENTER = 697,
    OF_PORT_STATS_PROP_EXPERIMENTER_INTEL = 698,
    OF_PORT_STATS_PROP_OPTICAL = 699,
    OF_QUEUE_DESC = 700,
    OF_QUEUE_DESC_PROP = 701,
    OF_QUEUE_DESC_PROP_BSN = 702,
    OF_QUEUE_DESC_PROP_BSN_QUEUE_NAME = 703,
    OF_QUEUE_DESC_PROP_EXPERIMENTER = 704,
    OF_QUEUE_DESC_PROP_MAX_RATE = 705,
    OF_QUEUE_DESC_PROP_MIN_RATE = 706,
    OF_QUEUE_PROP = 707,
    OF_QUEUE_PROP_EXPERIMENTER = 708,
    OF_QUEUE_PROP_MAX_RATE = 709,
    OF_QUEUE_PROP_MIN_RATE = 710,
    OF_QUEUE_STATS_ENTRY = 711,
    OF_QUEUE_STATS_PROP = 712,
    OF_QUEUE_STATS_PROP_EXPERIMENTER = 713,
    OF_ROLE_PROP = 714,
    OF_ROLE_PROP_EXPERIMENTER = 715,
    OF_TABLE_DESC = 716,
    OF_TABLE_FEATURE_PROP = 717,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS = 718,
    OF_TABLE_FEATURE_PROP_APPLY_ACTIONS_MISS = 719,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD = 720,
    OF_TABLE_FEATURE_PROP_APPLY_SETFIELD_MISS = 721,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER = 722,
    OF_TABLE_FEATURE_PROP_EXPERIMENTER_MISS = 723,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS = 724,
    OF_TABLE_FEATURE_PROP_INSTRUCTIONS_MISS = 725,
    OF_TABLE_FEATURE_PROP_MATCH = 726,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES = 727,
    OF_TABLE_FEATURE_PROP_NEXT_TABLES_MISS = 728,
    OF_TABLE_FEATURE_PROP_TABLE_SYNC_FROM = 729,
    OF_TABLE_FEATURE_PROP_WILDCARDS = 730,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS = 731,
    OF_TABLE_FEATURE_PROP_WRITE_ACTIONS_MISS = 732,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD = 733,
    OF_TABLE_FEATURE_PROP_WRITE_SETFIELD_MISS = 734,
    OF_TABLE_FEATURES = 735,
    OF_TABLE_MOD_PROP = 736,
    OF_TABLE_MOD_PROP_EVICTION = 737,
    OF_TABLE_MOD_PROP_EXPERIMENTER = 738,
    OF_TABLE_MOD_PROP_VACANCY = 739,
    OF_TABLE_STATS_ENTRY = 740,
    OF_UINT32 = 741,
    OF_UINT64 = 742,
    OF_UINT8 = 743,
    ...
    /* List objects */
    OF_LIST_ACTION = 744,
    OF_LIST_ACTION_ID = 745,
    OF_LIST_ASYNC_CONFIG_PROP = 746,
    OF_LIST_BSN_CONTROLLER_CONNECTION = 747,
    OF_LIST_BSN_DEBUG_COUNTER_DESC_STATS_ENTRY = 748,
    OF_LIST_BSN_DEBUG_COUNTER_STATS_ENTRY = 749,
    OF_LIST_BSN_FLOW_CHECKSUM_BUCKET_STATS_ENTRY = 750,
    OF_LIST_BSN_GENERIC_STATS_ENTRY = 751,
    OF_LIST_BSN_GENTABLE_BUCKET_STATS_ENTRY = 752,
    OF_LIST_BSN_GENTABLE_DESC_STATS_ENTRY = 753,
    OF_LIST_BSN_GENTABLE_ENTRY_DESC_STATS_ENTRY = 754,
    OF_LIST_BSN_GENTABLE_ENTRY_STATS_ENTRY = 755,
    OF_LIST_BSN_GENTABLE_STATS_ENTRY = 756,
    OF_LIST_BSN_INTERFACE = 757,
    OF_LIST_BSN_LACP_STATS_ENTRY = 758,
    OF_LIST_BSN_PORT_COUNTER_STATS_ENTRY = 759,
    OF_LIST_BSN_SWITCH_PIPELINE_STATS_ENTRY = 760,
    OF_LIST_BSN_TABLE_CHECKSUM_STATS_ENTRY = 761,
    OF_LIST_BSN_TLV = 762,
    OF_LIST_BSN_VLAN_COUNTER_STATS_ENTRY = 763,
    OF_LIST_BSN_VLAN_MAC = 764,
    OF_LIST_BSN_VRF_COUNTER_STATS_ENTRY = 765,
    OF_LIST_BUCKET = 766,
    OF_LIST_BUCKET_COUNTER = 767,
    OF_LIST_BUNDLE_PROP = 768,
    OF_LIST_FLOW_STATS_ENTRY = 769,
    OF_LIST_GROUP_DESC_STATS_ENTRY = 770,
    OF_LIST_GROUP_STATS_ENTRY = 771,
    OF_LIST_HELLO_ELEM = 772,
    OF_LIST_INSTRUCTION = 773,
    OF_LIST_INSTRUCTION_ID = 774,
    OF_LIST_METER_BAND = 775,
    OF_LIST_METER_BAND_STATS = 776,
    OF_LIST_METER_CONFIG = 777,
    OF_LIST_METER_STATS = 778,
    OF_LIST_OXM = 779,
    OF_LIST_PACKET_QUEUE = 780,
    OF_LIST_PORT_DESC = 781,
    OF_LIST_PORT_DESC_PROP = 782,
    OF_LIST_PORT_MOD_PROP = 783,
    OF_LIST_PORT_STATS_ENTRY = 784,
    OF_LIST_PORT_STATS_PROP = 785,
    OF_LIST_QUEUE_DESC = 786,
    OF_LIST_QUEUE_DESC_PROP = 787,
    OF_LIST_QUEUE_PROP = 788,
    OF_LIST_QUEUE_STATS_ENTRY = 789,
    OF_LIST_QUEUE_STATS_PROP = 790,
    OF_LIST_ROLE_PROP = 791,
    OF_LIST_TABLE_DESC = 792,
    OF_LIST_TABLE_FEATURE_PROP = 793,
    OF_LIST_TABLE_FEATURES = 794,
    OF_LIST_TABLE_MOD_PROP = 795,
    OF_LIST_TABLE_STATS_ENTRY = 796,
    OF_LIST_UINT32 = 797,
    OF_LIST_UINT64 = 798,
    OF_LIST_UINT8 = 799,
