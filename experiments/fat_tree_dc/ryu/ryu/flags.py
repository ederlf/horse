...
CONF.register_cli_opts([
    # tests/switch/tester
    cfg.StrOpt('config', help='Path to the configuration file'),
], group='ixp-app')

CONF.register_cli_opts([
    # tests/switch/tester
    cfg.StrOpt('topo', default='ft,4', help='Type of the topology'),
    cfg.StrOpt('routing', default='hashed', help='routing algorithm'),
    cfg.StrOpt('bw', default='hashed', help='test bandwidth'),
], group='hedera')
