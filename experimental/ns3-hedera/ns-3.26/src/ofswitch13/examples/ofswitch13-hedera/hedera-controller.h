...
#ifndef HEDERA_CONTROLLER_H
#define HEDERA_CONTROLLER_H
 ...
 */
class HederaController : public OFSwitch13Controller
{
public:
  HederaController ();          //!< Default constructor
  virtual ~HederaController (); //!< Dummy destructor.
